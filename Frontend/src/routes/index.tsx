...
import { BarChart3, Filter, Tag } from "lucide-react";
          ...
          {filteredDashboards.map((d) => (
            ...
            >
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "1rem", fontSize: "0.75rem", color: "#94a3b8", marginBottom: "1rem" }}>
                  ...
                  <span style={{ display: "inline-flex", alignItems: "center", gap: "0.35rem" }}>
                    ...
                    <span>{d.dataset_version_id}</span>
                  </span>
                </div>
              </div>
