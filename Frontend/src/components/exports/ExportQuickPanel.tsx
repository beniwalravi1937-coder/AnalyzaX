...
const SOURCE_OPTIONS: { type: ExportSourceType; Icon: LucideIcon }[] = [
  { type: "DATASET", Icon: BarChart3 },
  { type: "SQL_RESULT", Icon: Search },
  { type: "PROFILE", Icon: ClipboardList },
  { type: "QUALITY_REPORT", Icon: ShieldCheck },
  { type: "EDA_RESULT", Icon: Microscope },
  { type: "STATISTICS_RESULT", Icon: TrendingUp },
  { type: "ML_RESULT", Icon: Cpu },
  { type: "FORECAST_RESULT", Icon: TrendingDown },
  { type: "DASHBOARD", Icon: LayoutDashboard },
  { type: "AI_ANALYST_SESSION", Icon: Brain },
];
