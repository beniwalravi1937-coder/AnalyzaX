  ...
  return (
    <div className="landing-page" style={{ minHeight: "100vh", backgroundColor: "#0b0f19", color: "#f8fafc", fontFamily: "var(--font-sans)" }}>
      ...
      <section id="preview" style={{ padding: "1rem 1.5rem 5rem", maxWidth: "1240px", margin: "0 auto" }}>
        <BrowserFrame
          url="app.analyzax.ai/workspace/student_exam_performance.csv"
          title="student_exam_performance.csv"
          badge={
            <div className="flex items-center gap-2">
              <span className="text-[10px] bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 px-2 py-0.5 rounded font-semibold tracking-wider">
                100,000 ROWS AUDITED
              </span>
              <span className="text-[10px] bg-indigo-500/15 text-indigo-300 border border-indigo-500/30 px-2 py-0.5 rounded font-semibold tracking-wider">
                44 ATTRIBUTES
              </span>
            </div>
          }
