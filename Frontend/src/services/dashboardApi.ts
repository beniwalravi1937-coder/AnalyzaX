    ...
    components.push(
      {
        ...
        source: { source_type: "VISUALIZATION", dataset_id: payload.dataset_id, dataset_version_id: payload.dataset_version_id || "v1", engine: "viz" },
        dataset_id: payload.dataset_id,
      ...
      },
      {
        ...
        size: { width: 12, height: 6 },
        configuration: { limit: 25 },
        source: { source_type: "SQL_RESULT", dataset_id: payload.dataset_id, dataset_version_id: payload.dataset_version_id || "v1", engine: "duckdb" },
        dataset_id: payload.dataset_id,
        dataset_version_id: payload.dataset_version_id || "v1",
        created_at: now,
      }
    ...
    components.push(
      {
        ...
        source: { source_type: "ML_RESULT", dataset_id: payload.dataset_id, dataset_version_id: payload.dataset_version_id || "v1", engine: "ml" },
        dataset_id: payload.dataset_id,
        dataset_version_id: payload.dataset_version_id || "v1",
        created_at: now,
      },
...
function addLocalComponent(dashboardId: string, payload: ComponentCreateRequest): DashboardComponent {
  ...
  const newComp: DashboardComponent = {
    ...
    size: payload.size || { width: 6, height: 4 },
    configuration: payload.configuration,
    source: payload.source,
    dataset_id: (payload as any).dataset_id || "",
    dataset_version_id: (payload as any).dataset_version_id || "v1",
