...
export default function ProjectsPage() {
  ...
  // Keyboard shortcut listeners (⌘K for search, ⌘N for new project)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen p-6 lg:p-10 max-w-[1400px] mx-auto space-y-8 animate-in fade-in duration-200 relative">
      ...
      {/* ==================== CONTROL STRIP: TABS, FILTERS & SEARCH ==================== */}
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-6">
          {filteredProjects.map((proj) => {
            ...
            return (
              <article
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = '#121620';
              ...
              >
                ...
                {/* Card Main Body */}
                <div className="p-6">
                  {/* Top row: Icon Badge + Project Title + Status Pill */}
                  ...
                  {/* Telemetry Strip (Stitch specification) */}
                  <div className="flex flex-wrap items-center gap-y-1.5 gap-x-3 py-2 px-3 rounded-lg bg-slate-950/60 border border-white/[0.06] mb-4 font-mono text-[11px] text-slate-400">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-slate-200 font-semibold">4</span> Datasets
                    </div>
                    <span className="text-slate-600">•</span>
                    <div className="flex items-center gap-1.5">
                      <Layers className="w-3.5 h-3.5 text-slate-500" />
                      <span className="text-slate-200 font-semibold">12</span> Pipelines
                    </div>
                    <span className="text-slate-600">•</span>
                    <div className="flex items-center gap-1.5">
                      <Sparkles className="w-3.5 h-3.5 text-slate-500" />
                      <span className="text-slate-200 font-semibold">2</span> Models
                    </div>
                  </div>

                  {/* Engine Details & Last Updated */}
          ...
          {/* Quick-Create Dashed Tile (Stitch specification) */}
          <div
            onClick={() => setShowCreateModal(true)}
