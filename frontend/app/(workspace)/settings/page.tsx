    ...
    <div>
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", fontSize: "0.8125rem", color: "var(--text-secondary)", lineHeight: 1.6 }}>
          ...
          <p>
            &bull; <strong style={{ color: "var(--text-primary)" }}>Strict 4-Tier Layering:</strong> Presentation (Next.js) &rarr; API Routes (FastAPI) &rarr; Application Services &rarr; Pure Analytical Engines.
          </p>
        </div>
      </SectionCard>
    </div>
