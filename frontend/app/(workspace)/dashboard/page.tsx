...
import { DashboardIcon, BarChartIcon, DatasetIcon } from "@/components/icons";
...
export default function DashboardPage() {
  ...
  const handleCreateDashboard = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewName("");
      setNewDesc("");
      // Open the new dashboard immediately in the workspace
  ...
  // If a dashboard is opened, show the full studio workspace
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Transform analytical findings, KPI metrics, Phase 9 charts, statistics, and forecasts into persistent interactive dashboards."
