...
export default function VisualizationsPage() {
  ...
  useEffect(() => {
    ...
    async function loadVersions() {
      try {
        const vList = await api.getDatasetVersions(selectedDatasetId);
        setVersions(vList);
  ...
  // Select a recommendation or saved chart
  const handleSelectSpec = (spec: ChartSpec) => {
    // Ensure dataset & version match current context
  ...
  // Handle drilldown / click-to-filter from chart point
    ...
    <div className="container" style={{ padding: "1.5rem", maxWidth: "1400px", margin: "0 auto" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          >
            <RefreshIcon size={14} className={isRecsLoading ? "animate-spin" : ""} />
      ...
      {datasets.length === 0 ? (
        <EmptyState
          ...
          action={
            <Link href="/dataset" className="btn btn-primary btn-sm">
          ...
          >
            <button
              ...
              style={{
                background: "none",
                border: "none",
                borderBottom: activeTab === "recommendations" ? "2px solid var(--brand-primary, #6366f1)" : "2px solid transparent",
                padding: "0.6rem 0.5rem",
                color: activeTab === "recommendations" ? "var(--brand-primary, #6366f1)" : "var(--text-secondary)",
                fontWeight: 600,
                fontSize: "0.875rem",
                cursor: "pointer",
                display: "flex",
            ...
            <button
              ...
              style={{
                background: "none",
                border: "none",
                borderBottom: activeTab === "studio" ? "2px solid var(--brand-primary, #6366f1)" : "2px solid transparent",
                padding: "0.6rem 0.5rem",
                color: activeTab === "studio" ? "var(--brand-primary, #6366f1)" : "var(--text-secondary)",
                fontWeight: 600,
                fontSize: "0.875rem",
                cursor: "pointer",
                display: "flex",
            ...
            <button
              ...
              style={{
                background: "none",
                border: "none",
                borderBottom: activeTab === "saved" ? "2px solid var(--brand-primary, #6366f1)" : "2px solid transparent",
                padding: "0.6rem 0.5rem",
                color: activeTab === "saved" ? "var(--brand-primary, #6366f1)" : "var(--text-secondary)",
                fontWeight: 600,
                fontSize: "0.875rem",
                cursor: "pointer",
                display: "flex",
            ...
            <div>
              ...
              <div>
                ...
                {isRecsLoading ? (
                  ...
                  <div style={{ padding: "1rem", color: "var(--status-danger)", backgroundColor: "rgba(239, 68, 68, 0.1)", borderRadius: "0.5rem" }}>
                    {recsError}
                  </div>
                ) : (
                  <VisualizationGrid
          ...
          {activeTab === "saved" && (
            <div>
              {savedLoading ? (
                ...
                >
                  <BarChartIcon size={32} className="text-muted" style={{ margin: "0 auto 1rem auto" }} />
