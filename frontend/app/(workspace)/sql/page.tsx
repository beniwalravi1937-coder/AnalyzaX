              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: "0.25rem" }}>
                  <button
                    ...
                    className={`btn btn-sm ${outputTab === "results" ? "btn-primary" : "btn-ghost"}`}
                  ...
                  <button
                    ...
                    className={`btn btn-sm ${outputTab === "visualizer" ? "btn-primary" : "btn-ghost"}`}
                    style={{ fontSize: "0.75rem", padding: "0.3rem 0.7rem", borderRadius: "var(--radius-sm) var(--radius-sm) 0 0" }}
                  >
                  ...
                  <button
                    ...
                    className={`btn btn-sm ${outputTab === "explain" ? "btn-primary" : "btn-ghost"}`}
                    style={{ fontSize: "0.75rem", padding: "0.3rem 0.7rem", borderRadius: "var(--radius-sm) var(--radius-sm) 0 0" }}
                  >
                    <EyeIcon size={12} />
                    Execution Plan
                  ...
                  <button
                    ...
                    className={`btn btn-sm ${outputTab === "history" ? "btn-primary" : "btn-ghost"}`}
                    style={{ fontSize: "0.75rem", padding: "0.3rem 0.7rem", borderRadius: "var(--radius-sm) var(--radius-sm) 0 0" }}
                  >
                    <HistoryIcon size={12} />
                  ...
                  <button
                    ...
                    className={`btn btn-sm ${outputTab === "saved" ? "btn-primary" : "btn-ghost"}`}
                    style={{ fontSize: "0.75rem", padding: "0.3rem 0.7rem", borderRadius: "var(--radius-sm) var(--radius-sm) 0 0" }}
                  >
                    <SaveIcon size={12} />
